...
set output "charge_gaas_111.eps"
set key off
...
set arrow from sqrt3*alat/8.,24 to sqrt3*alat/8.,22  lw 2
set label 'As' at sqrt3*alat/8.,25.5 center
set arrow from -sqrt3*alat/8.,15 to -sqrt3*alat/8.,13  lw 2
set label 'Ga' at -sqrt3*alat/8.,16.5 left
